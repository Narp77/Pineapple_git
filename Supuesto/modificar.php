...
<form name="modificar" action="modificar2.php" method="post" onSubmit="return borrar()">
<?php
...
function borrar(){
	document.getElementById("numerito").value=document.forms["modificar"]["radiob"].value;
